...
class ViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    var alarm = [
        Alarm.init(timesString: "10:00", notesString: "Meeting", isSwitched: true),
        Alarm.init(timesString: "14:00", notesString: "IOS", isSwitched: true),
        Alarm.init(timesString: "16:00", notesString: "Android", isSwitched: true)
    ]
    ...
    @IBAction func addAction(_ sender: UIBarButtonItem) {
        let addVC = self.storyboard?.instantiateViewController(withIdentifier: "NewAlarmViewController") as? NewAlarmViewController
